...
public class PluginService{
			...
			Intent result, Uri obs, String hack)
	{
		...
		if (result != null){
			...
			else if(!TextUtils.isEmpty(action) && action.equals("inline-data")){
			...
			// Scanner hack
			else if(!TextUtils.isEmpty(action) && action.equals("com.google.zxing.client.android.SCAN")){
				...
				if(extras.containsKey(Intent.EXTRA_STREAM)){
					...
					type = "text/plain";
					stream = Uri.fromParts("data", type, null);
					Log.d(TAG, "....EXTRA_TEXT : " + stream);
				}
			}
