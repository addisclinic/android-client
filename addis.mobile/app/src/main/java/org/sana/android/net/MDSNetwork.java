...
public class MDSNetwork {
    ...
    public static MDSNetwork getInstanceForTest() {
        if (singleton == null) {
            singleton = new MDSNetwork(true);
        }
        return singleton;
    }

    private MDSNetwork(boolean isTestService) {
        ...
        builder = new Retrofit.Builder()
                .baseUrl("https://demo.sana.csail.mit.edu:443/mds/")
    ...
    private  <S> S createServiceWithAuth(Class<S> serviceClass) {
